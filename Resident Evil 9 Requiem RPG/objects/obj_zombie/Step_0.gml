...
if(l4945AF74_0)
{
	...
	if(point_distance(x,y,obj_playerleon.x,obj_playerleon.y) < walk_range)
	{
		...
		/// @DnDArgument : "maxymove" "0.8"
		/// @DnDArgument : "object" "obj_barrier"
		/// @DnDSaveInfo : "object" "obj_barrier"
		move_and_collide(lengthdir_x(var_zombie_speed, point_direction(x, y, obj_playerleon.x, obj_playerleon.y)), lengthdir_y(var_zombie_speed, point_direction(x, y, obj_playerleon.x, obj_playerleon.y)), obj_barrier,4,0,0,var_zombie_speed,0.8);
	}
