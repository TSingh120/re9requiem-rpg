 ...
 var _shoot = shotgun.fullauto ? mouse_check_button(mb_left) : mouse_check_button_pressed(mb_left);
 ...
 && !obj_playerleon.shotgun_reloading
 {
	...
	var _delay = shotgun.burst_delay;
	repeat (shotgun.burst_number - 1)
	{
		call_later(_delay, time_source_units_frames, Shoot);
		_delay += shotgun.burst_delay;
	}
 }
...
if keyboard_check_pressed(ord("R"))
{
    ...
    {
        if obj_playerleon.shotgun_reserve > 0
        {
